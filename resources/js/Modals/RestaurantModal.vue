        ...
        <div class="flex flex-col bg-green-800 w-full text-center py-4">
            <template v-if="restaurantsFound">
                ...
                <div v-for="restaurant in restaurants" :key="restaurant.id" class="flex flex-col mb-4">
                    <a :href="restaurant.share" target="_blank" class="text-white text-2xl mb-2 underline hover:text-green-300">{{ restaurant.title }}</a>
            ...
            <template v-else class="mb-4">
                ...
                <p class="text-green-200 text-base px-2"> Try changing your options...</p>
            </template>
        </div>
