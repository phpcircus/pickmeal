<template>
    <div class="flex flex-col py-1">
        <inertia-link class="flex px-3 py-2 hover:bg-teal-500 hover:text-white group" :href="route('users.edit', $page.auth.user.id)">
        ...
        <div v-if="$page.auth.user.is_admin">
            <inertia-link class="flex px-3 py-2 hover:bg-teal-500 hover:text-white group" :href="route('users.list')">
        ...
        <inertia-link class="flex px-3 py-2 hover:bg-teal-500 hover:text-white group" :href="route('logout')" method="post">
